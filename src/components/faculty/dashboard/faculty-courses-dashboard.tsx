...
export function FacultyCoursesDashboard() {
  const navigate = useNavigate()
  const searchParams = useSearch({ from: "/_authenticated/_faculty/f/" }) as Partial<DashboardSearch>
  ...
  const updateSearchParam = <K extends keyof DashboardSearch>(
    key: K,
    value: DashboardSearch[K]
  ) => {
    navigate({
      search: (prev) => ({
        ...prev,
        ...
        <CardContent>
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            <Select
              value={status}
              onValueChange={(value) =>
                updateSearchParam("status", value as DashboardSearch["status"])
              }
            >
            ...
            <Select
              value={sortBy}
              onValueChange={(value) =>
                updateSearchParam("sortBy", value as DashboardSearch["sortBy"])
              }
            >
              <SelectTrigger className="w-full sm:w-[180px]">
            ...
            <Select
              value={sortOrder}
              onValueChange={(value) =>
                updateSearchParam("sortOrder", value as DashboardSearch["sortOrder"])
              }
            >
