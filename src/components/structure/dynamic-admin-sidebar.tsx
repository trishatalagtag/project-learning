...
import { facultySidebarConfig } from "@/config/sidebar/faculty"
...
export default function DynamicAdminSidebar(props: React.ComponentProps<typeof Sidebar>): React.ReactNode {
    const userRole = useUserRole()

    // Select config based on user role
    const config = userRole === ROLE.FACULTY ? facultySidebarConfig : adminSidebarConfig
