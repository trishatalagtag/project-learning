import {
  ...
  CourseSidebarTitle,
} from "@/components/structure/course-sidebar-primitives"
    ...
    <CourseSidebarPrimitive>
      ...
      <CourseSidebarHeader>
        <CourseSidebarTitle asChild>
          <Link to="/c/$courseId" params={{ courseId }} title={`${courseTitle} - Home Page`}>
            {courseTitle}
          </Link>
        </CourseSidebarTitle>
      ...
      <CourseSidebarContent>
        ...
        <div className="border-sidebar-border border-b">
          <CourseLessonList>
            <CourseLesson asChild active={!currentModuleId && !currentLessonId}>
            ...
            <CourseModule key={module._id} defaultOpen={isDefaultOpen}>
              ...
              {hasLessons && (
                <CourseModuleContent>
                  <CourseLessonList>
                    {/* Module Overview */}
                    <CourseLesson asChild active={isCurrentModule && !currentLessonId}>
                      <Link
                    ...
                    {module.lessons.map((lesson) => {
                      ...
                      if (isLearner) {
                        ...
                        const progressRecord = lessonProgress?.find(
                      ...
                      return (
                        <CourseLesson key={lesson._id} asChild active={isCurrentLesson}>
                          <Link
