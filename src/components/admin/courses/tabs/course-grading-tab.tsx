        ...
        try {
            await updateGradingConfig({
                ...
                gradingConfig: {
                    ...
                    components:
                        values.gradingMethod === "weighted" ? values.components : undefined,
                },
            });
                                    ...
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <div className="grid gap-4 sm:grid-cols-3 mt-4">
                                                {(["numerical", "competency", "weighted"] as const).map(
                                                    (method) => {
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <div className="flex items-start gap-3">
                                                                    <div className={`rounded-lg p-2 ${gradingMethodInfo[method].color}`}>
                                                ...
                                                <Card className="border-dashed">
                                                    <CardContent className="flex flex-col items-center justify-center py-12">
                                                        ...
                                                        <p className="text-sm text-muted-foreground text-center mb-4 max-w-sm">
                                                            Add grading components or use a preset to get
                                                            started quickly
                                                        </p>
                                                        <div className="flex gap-2">
                                                            <Button
                            ...
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="font-semibold">
                                        {gradingMethodInfo[watchGradingMethod].title}
                                    </p>
                                </div>
                            </div>
                            <div>
